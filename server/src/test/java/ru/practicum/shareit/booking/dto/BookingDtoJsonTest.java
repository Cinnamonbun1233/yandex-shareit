...
public class BookingDtoJsonTest {
    ...
    void testBookingRequestDto() {
        ...
        assertThat(result).extractingJsonPathStringValue("$.start").isEqualTo(dateTimeFormatter.format(start));
        assertThat(result).doesNotHaveJsonPath("$.endDate");
        assertThat(result).extractingJsonPathStringValue("$.end").isEqualTo(dateTimeFormatter.format(end));
